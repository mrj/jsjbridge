...
var currentVersion = chrome.runtime.getManifest().version, licensedVersion, licensedVersionFloat;

document.addEventListener('DOMContentLoaded', () => {
  chrome.storage.local.get(['allowedURLPrefixes', 'licensed', 'licensedVersion', 'isAustralian'], storedValues => {
    ...
    function setLicensedState() {
      ...
      buyLink.target = price > 0 ? '_blank' : '_self';
      buyLink.title = price > 0 ? '' : 'No purchase necessary.';
    }
